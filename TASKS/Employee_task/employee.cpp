...
Employee::Employee(const std::string& name, Office* office): name(name), officePtr(office), empPtr(nullptr)
{
...
Employee::Employee(const std::string& name, Employee* emp): name(name), officePtr(nullptr), empPtr(emp)
{
